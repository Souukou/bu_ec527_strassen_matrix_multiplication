...
matrix_ptr strassen(matrix_ptr a, matrix_ptr b, matrix_ptr c) {
  ...
  strassen(add_matrix(a11, a22, temp1), add_matrix(b11, b22, temp2), m1);
  strassen(add_matrix(a21, a22, temp1), b11, m2);
  strassen(a11, sub_matrix(b12, b22, temp1), m3);
  strassen(a22, sub_matrix(b21, b11, temp1), m4);
  strassen(add_matrix(a11, a12, temp1), b22, m5);
  strassen(sub_matrix(a21, a11, temp1), add_matrix(b11, b12, temp2), m6);
  strassen(sub_matrix(a12, a22, temp1), add_matrix(b21, b22, temp2), m7);

  sub_matrix(add_matrix(m1, m4, temp1), sub_matrix(m5, m7, temp2), c11);
  add_matrix(m3, m5, c12);
  add_matrix(m2, m4, c21);
  add_matrix(sub_matrix(m1, m2, temp1), add_matrix(m3, m6, temp2), c22);
